...
| `POST /users` | Add a new user. | **id** - unique nickname <br> **timestamp** - [Timestamp] Can in whatever format you like, you can use `Date.now()` if you like. <br> **avatar** - [String] Avatar URL<br> **password** - [String] <br> **genre** - [String] Male or Female <br>|
| `GET /users/:id` | Get the details for a single user. | |
| `PUT /users/:id` | Edit the details of an existing user. | **avatar** - [String] Avatar URL <br> **password** - [String] <br> **genre** - [String] Male or Female <br>